        ...
        <div className="relative -mt-16 md:-mt-20 mb-8">
          <div className="flex flex-col md:flex-row gap-6 md:items-end">
            <div className="relative z-10">
              <div className="w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden border-4 border-[#0F0F0F] bg-[#0F0F0F]">
            ...
            <div className="flex-1 flex flex-col md:flex-row justify-between gap-4">
              ...
              <div className="flex gap-3">
                <Button variant="outline" size="icon" className="border-[#2A2A2A] h-10 w-10">
                ...
                <Button
                  className={isFollowing ? "bg-[#2A2A2A] hover:bg-[#3A3A3A]" : "bg-primary hover:bg-primary/90"}
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2">
              ...
              <div className="flex gap-6 mt-4">
                <div>
                  <span className="font-bold">{author.stats.items}</span>
                  <span className="text-white/70 ml-1">Items</span>
                </div>
                <div>
                  <span className="font-bold">{author.followers}K</span>
