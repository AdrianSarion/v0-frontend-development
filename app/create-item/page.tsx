...
import { Upload, Plus, Minus, Calendar, Clock, Tag, Wallet, DollarSign, Info } from "lucide-react"
            ...
            <div className="lg:col-span-3 space-y-8">
                  ...
                  <TabsContent value="open" className="mt-4 space-y-4">
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2 text-sm text-white/70 mt-2">
                        ...
                        <span>
                          Setting a reserve price is optional. If you set a reserve price, bids below this amount won't
                          be accepted.
                        </span>
                      </div>
                    </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <h2 className="text-xl font-medium">Royalties</h2>
                    <p className="text-sm text-white/70 mt-1">
                      Earn a percentage of the sale price when your NFT is sold
                    </p>
                  </div>
                  <div className="flex items-center gap-2">
                    <Input
                      type="number"
                      placeholder="10"
                      className="bg-[#1A1A1A] border-[#2A2A2A] focus-visible:ring-primary w-20 text-center"
                    />
                    <span>%</span>
                  </div>
                </div>
