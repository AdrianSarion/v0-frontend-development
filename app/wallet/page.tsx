...
import { Copy, ExternalLink, ChevronRight, CheckCheck, WalletIcon } from "lucide-react"
      ...
      <div className="container px-4 py-8 md:px-6 md:py-12">
        <div className="max-w-2xl mx-auto">
          <div className="flex flex-col gap-4 mb-8 text-center">
            <div className="mx-auto bg-[#1A1A1A] p-4 rounded-full">
          ...
          {!connected ? (
            ...
            <div className="bg-[#1A1A1A] rounded-xl p-6 space-y-6">
              ...
              <div className="space-y-2">
                <p className="text-sm text-white/70">Your NFTs</p>
                <div className="grid grid-cols-3 gap-3">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="bg-[#0F0F0F] rounded-lg overflow-hidden">
                      <Image
                ...
                <Link href="/profile" className="text-primary text-sm hover:underline block text-center mt-2">
                  View all NFTs
                </Link>
              </div>
